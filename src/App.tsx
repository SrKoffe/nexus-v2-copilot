  ...
  return (
    <div className="hud-container">
      ...
      <main className="trading-grid">
        ...
        <section className="order-area panel" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div className="panel-header">Pipeline & Setup</div>
          <div className="panel-content" style={{ display: 'flex', flexDirection: 'column', gap: '16px', overflowY: 'auto' }}>
            <HUD />
            <SetupCard />
          </div>
        </section>
